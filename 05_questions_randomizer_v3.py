...
Removes the list and randomizer (I thought it was too complicated
so I reverted to trying a longer but simpler method).
Adds ability to ask and check questions and answers
"""
