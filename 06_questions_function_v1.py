"""Maori Quiz Questions Function v1
Formats text slightly
Turns 05_questions_randomizer_v3 into a function
"""
...
def questions():
    ...
    ask_8 = input(f"What is the maori version of '{questions_8}'? (No Macron's): ")
    if ask_8 == answer_8:
        player += 1
        print()
        print("You got it right!")
